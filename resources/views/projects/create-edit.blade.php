...
<form method="POST" action="{{ route('projects.update', ['project' => $project]) }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control @error('name') is-invalid @enderror " placeholder="Apple ML"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="date" class="form-control @error('start_date') is-invalid @enderror " placeholder="01.01.2020"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="number" step="0.01" min="1" max="52"
                class="form-control @error('duration') is-invalid @enderror " placeholder="5,50" name="duration"
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="name" id="name" placeholder="Apple Inc"
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <textarea id="description" name="description" rows="5"
                                    ...
                                    placeholder="Lorem Ipsum...">@if(old('description')){{ old('description') }}@elseif(isset($project)){{ old('description', $project->description) }}@endif</textarea>
                                @error('description')
                                <div class="text-sm font-medium text-red-500">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="date" name="start_date" id="start_date" placeholder="01.01.2020"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" name="duration" id="duration" placeholder="2,50" type="number"
                                step="0.50" min="1" max="52"
