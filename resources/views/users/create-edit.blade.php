                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="username" id="username" autocomplete="username" placeholder="johndoe"
                            ...
                            value="@if(old('username')){{ old('username') }}@elseif(isset($username)){{ old('username', $user->username) }}@endif">
                        @error('username')
                        <div class="text-sm font-medium text-red-500">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select id="roles" name="roles" autocomplete="roles"
                            ...
                            <option @if(isset($user) && !empty($userRole) && in_array($role, $userRole)) selected @endif>
                                {{$role}}</option>
                            @endforeach
                        </select>
                        @error('roles')
