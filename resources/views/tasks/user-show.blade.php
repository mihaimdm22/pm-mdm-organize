...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            <form method="POST" action="{{ route('user.tasks.update', ['task' => $task]) }}" class="form-inline"
                role="form">
                @csrf
                @method('PUT')

                <select class="form-control @error('status') is-invalid @enderror mr-1" name="status" id="status">
    ...
    <div>
        <form method="POST" action="{{ route('user.comments.store', $task) }}" class="form">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control @error('text') is-invalid @enderror " placeholder="Lorem Ipsum..."
                        ...
                        <div>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        {{-- <div class="text-sm font-medium text-gray-900">
                                            <span
                                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-{{ $task->badge() }}-100
                                        text-{{ $task->badge() }}-700">{{ $task->status }}</span>
                                    </div> --}}
                                </div>
                            ...
                            <div class="py-10 xl:pt-6 xl:pb-0">
                                <form method="POST" action="{{ route('user.tasks.update', ['task' => $task]) }}"
                                    ...
                                    @csrf
                                    @method('PUT')
                                    <select class="block focus:ring-gray-500 focus:border-gray-500 shadow-sm sm:text-sm border-gray-300 rounded-md mb-1" name="status" id="status">
                                        @foreach ($statuses as $status)
